...
..  code-block:: php
    ...
    #[AsEventListener(identifier: 'example/page-module-category-summary')]
    final readonly class AddPageModuleCategorySummary
    {
        public function __construct(
            private PageCategorySummaryRenderer $renderer,
        ) {}
...
Use TYPO3's :php:`\TYPO3\CMS\Core\Attribute\AsEventListener`, not the Symfony
attribute of the same name - the Symfony one registers nothing here, silently.
